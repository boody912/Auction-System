...
public class BidPage extends JFrame 
{
	...
	//buttons
	private JButton place = new JButton("Submit");
		...
		public void actionPerformed(ActionEvent e) 
		{
			...
			if (checkPrice(offeredPrice))
			{
				...
				boolean success = comms.receiveConfirmationMessage();
                                boolean resPrice;
                                if (Float.parseFloat(offeredPrice)>item.getReservePrice()){
                                    resPrice=true;
                                }
                                else{
                                    resPrice=false;
				...
				{
					JOptionPane.showMessageDialog(bp, "Price is lower than current highest or the reserved Price. Refresh your list!", 
