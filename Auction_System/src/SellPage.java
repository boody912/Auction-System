...
public class SellPage extends JFrame
{
	...
	private JButton sale = new JButton("Submit");
			...
			if (checkTitle(t))
			{
				if (checkPrice(pr))
				{
					if (checkDateValid())
					{
						...
						{
							JOptionPane.showMessageDialog(sp, "Item could not be added", "Error", JOptionPane.ERROR_MESSAGE);
						}
					}
					else
					{
						JOptionPane.showMessageDialog(sp, "Your date is Expired", "Error", JOptionPane.ERROR_MESSAGE);
					}
				}
				else
				{
					JOptionPane.showMessageDialog(sp, "Please enter valid price", "Error", JOptionPane.ERROR_MESSAGE);
				}
			}
			else
			{
				JOptionPane.showMessageDialog(sp, "Please set Title", "Error", JOptionPane.ERROR_MESSAGE);
			}
		}	
	}
