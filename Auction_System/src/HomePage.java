...
public class HomePage extends JFrame {
    ...
    //Buttons
    private JButton filter = new JButton("Refresh");
    private JButton sell = new JButton("Sell Item");
    private JButton bid = new JButton("Make Bid");
    private JButton checkBids = new JButton("Your Bids");
    private JButton checkOldBids = new JButton("Your Old Bids");
    private JButton checkItems = new JButton("Active Auctions");
    private JButton checkOldItems = new JButton("Finished Auctions");
    ...
    private JCheckBox showInactiveItems = new JCheckBox();
    ...
    class UserListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (e.getSource() == sell) {
                ...
                UserBidPage ubp = new UserBidPage(bids, "Bids on Active Auctions");
                ubp.init();
                ...
                UserItemsPage uip = new UserItemsPage(list, "Your Active auctions");
                uip.init();
                ...
                //display then in a new window
                UserBidPage ubp = new UserBidPage(bids, "Bids on Finished Auctions");
                ubp.init();
    ...
    private String formatItem(Item item) {
        ...
        float reserved = item.getReservePrice();
