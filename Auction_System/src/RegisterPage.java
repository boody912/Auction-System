...
//		c.gridx = 1;
	...
	class RegisterListener implements ActionListener
	{
		...
		{	
			...
			if(p.checkCredentials())
			{
				...
				comms.sendMessage(new RegisterMessage(user.getText(), password.getPassword(), familyName.getText()));
	...
	{
		if (!user.getText().isEmpty() && (password.getPassword().length != 0) && !familyName.getText().isEmpty())
		{
			return true;
		}
